...
const graphicStats = [
  {
    ...
    label: "Awards",
    value: 12,
    desc: "Recognized for creative graphic excellence.",
  },
  {
    icon: "/project.svg",
    label: "Projects",
    value: 80,
    desc: "Diverse graphic design projects delivered.",
  },
  {
    icon: "/happy.svg",
    label: "Happy Clients",
    value: 60,
    desc: "Clients delighted with our designs.",
  },
  {
    icon: "/globe.svg",
    label: "Countries",
...
const GraphicDesign = () => (
  <>
    <Head>
      ...
      <meta
        name="description"
        content="Modern, creative graphic design services for your brand."
      />
    </Head>
      ...
      <section className="relative flex flex-col items-center justify-center min-h-[100vh] text-center">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          <h1 className="text-5xl font-extrabold mb-6 text-primary-600 dark:text-primary-400 drop-shadow-lg">
            Graphic Design That Captivates
          </h1>
          <p className="text-xl text-gray-700 dark:text-gray-300 mb-8">
            Transform your brand with stunning, creative graphics crafted for
            impact.
          </p>
          <Link
            href="/contact-us"
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 bg-gradient-to-br from-white via-gray-100 to-gray-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-10 backdrop-blur-xl">
          <div className="w-full md:w-2/3 flex flex-col justify-center">
            ...
            <p className="text-lg mb-6 leading-relaxed text-gray-700 dark:text-gray-300">
              Our creative excellence is recognized by leading organizations. We
              deliver innovative graphic solutions and outstanding service.
            </p>
            ...
            {[
              {
                icon: "/search.svg",
                title: "Discovery",
                desc: "We start by understanding your brand, goals, and vision.",
              },
              {
                icon: "/strategy.svg",
                title: "Strategy",
                desc: "We craft a custom creative plan for your brand.",
              },
              {
                icon: "/design.svg",
                title: "Design",
                desc: "We create beautiful, impactful graphics and layouts.",
              },
              {
                icon: "/dev.svg",
                title: "Production",
                desc: "We deliver your graphics in all required formats.",
              },
              {
                icon: "/launch.svg",
                title: "Launch",
                desc: "We help you deploy and showcase your new visuals.",
              },
              {
                icon: "/support.svg",
                title: "Support",
        ...
        <div className="flex flex-wrap gap-10 justify-center items-center pb-4">
          {[
            ...
            },
            {
              ...
              desc: "Graphics that match your brand identity perfectly.",
            },
            {
              icon: "/globe.svg",
              title: "Global Reach",
              desc: "Designs for international audiences and accessibility.",
            },
            {
              icon: "/vercel.svg",
              title: "Easy Delivery",
        ...
        <div className="flex flex-wrap gap-10 justify-center items-center pb-4">
          ...
          <div className="relative flex flex-col items-center justify-center w-80 rounded-3xl shadow-2xl bg-gradient-to-br from-cyan-50 via-amber-50 to-white dark:from-cyan-900 dark:via-amber-900 dark:to-gray-900 group hover:scale-[1.07] transition-all duration-300">
            ...
            <div className="flex flex-col items-center justify-center h-full pt-12 pb-10">
              ...
              <ul className="text-gray-800/80 dark:text-gray-200 text-center mb-2 px-4 space-y-1">
                <li>Logo, Branding & Stationery</li>
                <li>Social Media & Ad Kit</li>
                <li>5 Revisions</li>
          ...
          <div className="relative group w-full max-w-lg">
            ...
            <div className="relative bg-white dark:bg-gray-900 rounded-3xl shadow-2xl p-12 flex flex-col items-center justify-center min-w-[340px]">
              ...
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-8 text-center">
                Ready to start your next graphic design project? Reach out for a
