  ...
  const contentStats = [
    {
      ...
      label: t("contentWriting.statsAwards"),
      value: 6,
      desc: t("contentWriting.statsAwardsDesc"),
    },
    {
      ...
      label: t("contentWriting.statsProjects"),
      value: 50,
      desc: t("contentWriting.statsProjectsDesc"),
    },
    {
      ...
      label: t("contentWriting.statsClients"),
      value: 40,
      desc: t("contentWriting.statsClientsDesc"),
    },
    {
      icon: "/globe.svg",
      label: t("contentWriting.statsCountries"),
      value: 12,
      desc: t("contentWriting.statsCountriesDesc"),
    },
  ];
  return (
    <>
